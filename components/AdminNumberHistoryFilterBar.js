...
// Same pattern as AdminTransactionsFilterBar — plain GET-style search,
// submitting pushes `?q=...` onto the URL for the server component to
// re-query with.
export default function AdminNumberHistoryFilterBar({ initialQuery = "" }) {
  ...
  function handleSubmit(e) {
    ...
    router.push(trimmed ? `/admin/number-history?q=${encodeURIComponent(trimmed)}` : "/admin/number-history");
  }
