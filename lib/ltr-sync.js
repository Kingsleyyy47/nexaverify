...
// PARKED (2026-07-31): not called by the active API route. DaisySMS's current
// .io sms-activate-compatible docs for this account do not document /api/ltrs
// or setAutoRenew, and live testing found no working bulk LTR sync source.
// Keep this file as implementation notes for the day DaisySMS confirms a real
// list/expiry endpoint for this account.
...
// If re-enabled, this would pull the authoritative long-term-rental list from
// DaisySMS (GET /api/ltrs) and:
