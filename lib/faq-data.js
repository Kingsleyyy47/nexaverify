...
export const FAQ_CATEGORIES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Codes usually arrive within seconds of the service sending them. NexaVerify checks for new messages continuously and also receives them the moment DaisySMS forwards them, so you don't need to keep refreshing.",
      },
    ],
  },
  {
